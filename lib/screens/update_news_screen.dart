                          ...
                          if (snapshot.connectionState ==
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                final news_instance = news[index];
                                ...
                                return Card(
                                  ...
                                  child: ListTile(
                                    leading: Container(
                                      ...
                                      child: news_instance.imageUrl != null
                                          ? ClipRRect(
                                        borderRadius:
                                        BorderRadius.circular(8.0),
                                        child: Image.network(
                                          news_instance.imageUrl!,
                                          fit: BoxFit.fill,
                                          loadingBuilder:
                                    ...
                                    subtitle: Column(
                                      ...
                                      children: [
                                        Text(
                                          news_instance.description ?? "No Description",
                                          style: const TextStyle(
                                              fontSize: 12,
                                        ...
                                        ElevatedButton(
                                          ...
                                          child: Text(
                                            news_instance.buttonText ?? "Button",
                                            style: const TextStyle(
                                                color: whiteColor),
                                          ),
                                        ),
